...
type
  TForm1 = class(TForm)
    ...
    procedure UpdateEmailConfiguration(Sender: TObject);
    procedure EmailEditChange(Sender: TObject);
  private
    { Private declarations }
    procedure UpdateStatistics;
    procedure UpdateEmailConfig;
  public
    { Public declarations }
  end;
...
procedure TForm1.UpdateEmailConfiguration(Sender: TObject);
begin
    UpdateEmailConfig;
end;

procedure TForm1.EmailEditChange(Sender: TObject);
begin
    UpdateEmailConfig;
end;

procedure TForm1.UpdateEmailConfig;
begin
    WapApp1['POP3Server'] := POP3ServerEdit.Text;
    WapApp1['EmailAccount'] := EmailEdit.Text;
end;
